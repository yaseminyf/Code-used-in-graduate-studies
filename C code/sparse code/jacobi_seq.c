...
/* get the necessary storage for A^TA */
     ...
     sym_mult3(AA,lnzv,ddiag,invpptr[l+1],xnzsubptr[l+1],nzsubptr[l+1],xrnzptr[l+1],isub,jsub,values);
...
printf("before orcolb..\n");     
   orcolb(T);
printf("after orcolb for C..\n");
