...
/* updates with synchronizaton after planar search                          */
/****************************************************************************/
...
printf("\n before loop...\n");
     ...
     while (converged==0) { 
       ...
       for (i=1;i<=ngroup;i++) {
         ...
         j=2*ngroup;
         if ( (counter % j) == 0) { /* time to do planar search */
           planeflag=1;
