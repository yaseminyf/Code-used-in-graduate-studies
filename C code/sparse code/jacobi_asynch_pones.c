/* last revised 12.01.1999                                             */
/* jacobi_asynch_pones.c = routine for solving the LSQ problem iteratively    */
/* and using jacobi updates                                            */
/* this version computes Jacobi with constant p (1 and FM)              */
...
/* if not converged then send residual */
