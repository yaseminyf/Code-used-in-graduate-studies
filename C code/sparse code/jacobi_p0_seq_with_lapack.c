/* last revised 06.09.1999                                             */
/* jacobi_p0_seq_with_lapack.c = routine for solving the LSQ problem   */
/* iteratively and using jacobi updates and subspace corrections       */
/* This is the sequential algorithm assuming hatA matrix is full, and  */
/* using blas3 and lapack routines in planar search                    */
/***********************************************************************/
#include "mpi.h"
#include <unistd.h>
#include <limits.h>
...
/* variables for lapack and blas3 routines */
